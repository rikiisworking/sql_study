-- Integrated drill dataset (lessons 0001–0006). Do not edit for practice.
-- Same grain as seeds/seed.sql, extra rows + order_date for stacked traps.
...
CREATE TABLE orders (
  ...
  status TEXT,
  order_date TEXT NOT NULL  -- ISO date; filter as a half-open range
);
