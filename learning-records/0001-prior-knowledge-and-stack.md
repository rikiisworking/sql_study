...
**Implications:** Skip intro CRUD. Lead with correctness (grain, joins, NULL), then portable optimization mental models, then engine-specific plan reading. Aurora dialect (MySQL vs PostgreSQL) still unknown—resolve before deep EXPLAIN drills.

**Status:** active (baseline). Progress after this: see LR-0002–0005.
